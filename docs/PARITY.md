...
| CardKit | Thinking, Generating, tool running/success/failure, Complete/Error, cumulative content streaming, and Hermes approval actions | Physical client clicks, footer parity, and reasoning-delta presentation |
